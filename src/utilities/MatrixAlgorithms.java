...
public class MatrixAlgorithms {
    ...
    public static void WinogradOriginal(int[][] A, int[][] B, int[][] Result, int N, int P, int M) {
        int i, j, k;
        int aux;
        //constantes necesarias para el Método
        int upsilon = P % 2; //Residuo del tamaño / 2 -> 1(impar) o 0(par)
        int gamma = P - upsilon; //El tamaño menos el resultado del residuo del tamaño / 2
